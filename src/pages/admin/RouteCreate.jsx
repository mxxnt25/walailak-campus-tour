...
export default function RouteCreate() {
  ...
  useEffect(() => {
    sessionStorage.setItem("route-create-draft", JSON.stringify(form));
  }, [form]);
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setError("สร้างเส้นทางไม่สำเร็จ กรุณาลองอีกครั้ง");
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-primary">สร้างเส้นทางใหม่</h1>
        ...
        >
          ...
          <div className="flex flex-wrap justify-end gap-2 border-t border-border pt-4">
            ...
            <Button type="submit" disabled={submitting}>
              {submitting ? "กำลังบันทึก..." : "สร้างเส้นทาง"}
            </Button>
          </div>
        </form>
      </Card>
